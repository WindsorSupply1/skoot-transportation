...
/**
 * Script to make all departures appear fully booked until October 1, 2025
 * This will generate departures with bookedSeats = capacity until that date
 */
...
async function setBookedUntilOctober() {
  try {
    console.log('🚌 Setting all departures as fully booked until October 1, 2025...\n');

    // Define date range
    const startDate = new Date(); // Today
    const endDate = new Date('2025-10-01'); // October 1, 2025
    ...
    // Generate departures for each day until October 1, 2025
    ...
    console.log(`📅 All departures until October 1, 2025 are now marked as FULLY BOOKED`);
    
    // Now generate available departures starting October 1, 2025
    console.log(`\n🆕 Generating available departures starting October 1, 2025...`);
    
    const availableStartDate = new Date('2025-10-01');
    ...
    console.log(`✅ Created ${availableCreated} available departures starting October 1, 2025`);
    
    console.log(`\n🎯 SUMMARY:`);
    console.log(`• All departures until October 1, 2025: FULLY BOOKED`);
    console.log(`• Departures from October 1, 2025 onwards: AVAILABLE for booking`);
    console.log(`• Customers will see "Sold Out" until October 1, 2025`);
    console.log(`• Booking will open automatically on October 1, 2025`);
