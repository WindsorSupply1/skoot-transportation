const scheduleData = [
  {
    ...
    weekdays: ['6:00 AM', '8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '6:00 PM', '8:00 PM'],
    weekends: ['8:00 AM', '12:00 PM', '6:00 PM'],
    duration: '45 min',
  },
  {
    route: 'Airport → Downtown',
    weekdays: ['7:00 AM', '9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM', '7:00 PM', '9:00 PM'],
    weekends: ['9:00 AM', '1:00 PM', '7:00 PM'],
    duration: '45 min',
  },
  {
    route: 'Business District → Airport',
    weekdays: ['6:30 AM', '8:30 AM', '10:30 AM', '12:30 PM', '2:30 PM', '6:30 PM', '8:30 PM'],
