                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className={`text-xs ${getStatusColor(booking.status)}`}>
                          {booking.status === 'PAID' && <CheckCircle className="inline h-3 w-3 mr-1" />}
                          {booking.status === 'CANCELLED' && <XCircle className="inline h-3 w-3 mr-1" />}
                          {booking.status === 'PENDING' && <Clock className="inline h-3 w-3 mr-1" />}
                          {booking.status}
                        </div>
                      </div>
                    </div>
