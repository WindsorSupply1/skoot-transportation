"use strict";(()=>{var e={};e.id=4109,e.ids=[4109],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},18094:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>g,patchFetch:()=>y,requestAsyncStorage:()=>l,routeModule:()=>p,serverHooks:()=>m,staticGenerationAsyncStorage:()=>h});var s={};r.r(s),r.d(s,{GET:()=>c,dynamic:()=>n});var a=r(49303),i=r(88716),o=r(60670),u=r(87070),d=r(20728);let n="force-dynamic";async function c(e){try{let{searchParams:t}=new URL(e.url),r=t.get("routeId"),s=`
      SELECT 
        s.id,
        s."routeId",
        s."dayOfWeek",
